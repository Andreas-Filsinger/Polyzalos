...
const
  // Linux Kernel Error Codes as Text
  cErrorCode : array[1..133] of string = (
    ...
    'EUNUSED Torvalds has left the building',
    ...
    'EBADMSG Not a data message|Bad CRC detected',
    ...
    'EUCLEAN Structure needs cleaning|Filesystem is corrupted',
